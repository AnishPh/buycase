...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits"> <?php print t('Designed and developed by '); ?> &nbsp Arjun Sridharkumar</p>
    <div class="clear"></div>
    </div>
  </div>
  </div>
